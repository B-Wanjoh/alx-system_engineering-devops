...
-The script inside file "4-lastlines" displays the last 10 lines of /etc/passwd.
...
-The script inside file "10-no_more_js" deletes all the regular files with a .js extension that are present in the current directory and all its subfolders.
